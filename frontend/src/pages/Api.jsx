...
<div className="flex flex-wrap w-full  p-4">
    ...
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 pt-10 pb-16 text-center ">

    <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="inline-block">
            <span className="relative whitespace-nowrap text-sky-900">
            ...
            <span className="relative"> ICIMS </span></span>
        </span>
        <span className="inline-block"> &nbsp; Public Api.</span>
    </h1>

    <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        <span className="inline-block">Integrate Criminal informations &nbsp;</span>
        <span className="inline-block">into your own  projects.</span>
    </p>

    <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
        <a className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-sky-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300  animate-fade-in-left"
            href="#">
...
<div className="lg:flex md:flex-row sm:flex-noe mr-5">
<div className="container mb-5">
<section className="text-gray-600 body-font ">
  <div className="">
    <div className="flex   sm:items-center md:w-2/3 mx-auto">
      <div className="  flex sm:items-center items-start flex-col   md:flex-row">
        <div className="flex-shrink-0 lg:w-20 lg:h-20 md:w-14 md:h-14 bg-sky-100 text-sky-950 rounded-full inline-flex items-center justify-center">
  ...
  <path fill-rule="evenodd" d="M2.625 6.75a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Zm4.875 0A.75.75 0 0 1 8.25 6h12a.75.75 0 0 1 0 1.5h-12a.75.75 0 0 1-.75-.75ZM2.625 12a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0ZM7.5 12a.75.75 0 0 1 .75-.75h12a.75.75 0 0 1 0 1.5h-12A.75.75 0 0 1 7.5 12Zm-4.875 5.25a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Zm4.875 0a.75.75 0 0 1 .75-.75h12a.75.75 0 0 1 0 1.5h-12a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd" />
        ...
        <div className=" sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Get wanted</h2>
          <p className="leading-relaxed">Get request, fetchs wanted criminals from database</p>
        </div>
      </div>
    </div>
  </div>
...
<section className="text-gray-600 body-font ">
  ...
  <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.125 4.5a4.125 4.125 0 1 0 2.338 7.524l2.007 2.006a.75.75 0 1 0 1.06-1.06l-2.006-2.007a4.125 4.125 0 0 0-3.399-6.463Z" clip-rule="evenodd" />
        ...
        <div className=" sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Check status</h2>
          <p className="leading-relaxed">POST request, Check if a person have a criminal record</p>
        </div>
      </div>
    </div>
  </div>
...
<section className="text-gray-600 body-font ">
  ...
  <path fill-rule="evenodd" d="M4.5 3.75a3 3 0 0 0-3 3v10.5a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V6.75a3 3 0 0 0-3-3h-15Zm4.125 3a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Zm-3.873 8.703a4.126 4.126 0 0 1 7.746 0 .75.75 0 0 1-.351.92 7.47 7.47 0 0 1-3.522.877 7.47 7.47 0 0 1-3.522-.877.75.75 0 0 1-.351-.92ZM15 8.25a.75.75 0 0 0 0 1.5h3.75a.75.75 0 0 0 0-1.5H15ZM14.25 12a.75.75 0 0 1 .75-.75h3.75a.75.75 0 0 1 0 1.5H15a.75.75 0 0 1-.75-.75Zm.75 2.25a.75.75 0 0 0 0 1.5h3.75a.75.75 0 0 0 0-1.5H15Z" clip-rule="evenodd" />
        ...
        <div className=" sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Responses</h2>
          <p className="leading-relaxed">The responses will be in json formats, examples..</p>
        </div>
      </div>
    </div>
  </div>
