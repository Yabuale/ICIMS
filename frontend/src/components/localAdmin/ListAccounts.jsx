...
<>
        <br/>
        <br/>
<section class="container px-4  mx-24      shadow-2xl bg-sky-50 p-10 rounded-2xl w-4/5  md:w-9/12 lg:w-4/5">
    <div class="flex items-center gap-x-3">
        <h2 class="text-lg font-medium text-sky-950 ">Wanted</h2>

        <span class="px-3 py-1 text-xs text-sky-950 bg-sky-200 rounded-full  ">100 Posted</span>
    </div>
    <div className="flex items-center justify-center p-6">
            <div className="w-full max-w-lg">
                <form className="mt-5 sm:flex sm:items-center">
                    <input id="q" name="q" className="inline w-full rounded-md border border-gray-300 bg-white py-2 pl-3 pr-3 leading-5 placeholder-gray-500 focus:border-sky-500 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="search an account" type="search" autoFocus value="" />
                    <button type="submit" className="mt-3 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-sky-600 px-4 py-2 font-medium text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Search
                    </button>
                </form>
            </div>
    ...
    <div class="flex flex-col mt-6  lg:pr-1 ">
        <div class=" w-full">
            <div class="">
                <div class=" ">
                    <table class=" w-full  ">
                        <thead class="bg-sky-700  ">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Age</th>

                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Reward</th>
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Action</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 ">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 ">oliviawathan@example.com</td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                    <p>24</p>
                                    </div>
