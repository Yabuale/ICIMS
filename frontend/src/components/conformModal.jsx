          ...
          <div className="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            ...
            <div className="">
              ...
              <div className="p-3  mt-2 text-center space-x-4 md:block">
                  ...
                  <button className="mb-2 md:mb-0 bg-sky-700 border border-sky-700 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg  hover:bg-sky-600" type='submit'>
                  <span class="border-white h-3 w-3 mx-auto animate-spin rounded-full border-8 border-t-sky-700" style={{ display: isLoading ? 'block' : 'none' }}> </span>
