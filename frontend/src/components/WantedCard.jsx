    ...
    return (
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="bg-sky-50 p-6 rounded-lg shadow-2xl">
          ...
          <h2 className="text-lg text-gray-900 font-medium title-font mb-1">Mr Kebede </h2>
          <div className="flex"><p className="mr-10"><span className="text-sky-800 font-bold">Alias:</span> McLovin </p> 
