...
const WantedCard = (props) => {
    const { id,name,alias,description,age,criminal_offenses,last_known_location, date_posted ,photo} = props;
  
    return (
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="bg-sky-50 p-6 rounded-lg shadow-2xl">
          <img className="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72 rounded w-full  object-scale-down object-center mb-6" src={`http://127.0.0.1:8000/${photo}`} alt="criminal img" />
