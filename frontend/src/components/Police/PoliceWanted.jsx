  ...
  <div className="container px-5 py-24 mx-auto max-w-7x1">
    <div className="flex flex-wrap w-full mb-4 p-4">
      <div className="w-full mb-6 lg:mb-0">
        <h1 className="sm:text-4xl text-5xl font-medium font-bold title-font mb-2 text-sky-950">Wanted Around Your Area</h1>
        <div className="h-1 w-80 bg-sky-800 rounded"></div>
      </div>
    </div>
