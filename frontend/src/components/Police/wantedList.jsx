     ...
     fetchLocalaccounts();
      ...
      if (!wantedCriminal || wantedCriminal.length === 0) {
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            ...
            <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 ">No Wanted criminal</p>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Seems like there you didn't post any wanted criminals.</p>
...
<section className="container px-4  mx-24      shadow-2xl bg-sky-50 p-10 rounded-2xl w-4/5  md:w-9/12 lg:w-4/5">
    <div className="flex items-center gap-x-3">
        ...
        <span className="px-3 py-1 text-xs text-sky-950 bg-sky-200 rounded-full  ">{wantedCriminal.length} Posted</span>
    </div>
                    ...
                    <table className=" w-full  ">
                        <thead className="bg-sky-700  ">
                            <tr>
                                ...
                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Age</th>

                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Reward</th>
...
<td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 ">
        ...
        <h2 className="text-sm font-normal text-emerald-500">Wanted</h2>
    </div>
</td>
<td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{wanted.last_known_location}</td>
<td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{wanted.age}</td>
