...
const ClerkCards = () =>{
    ...
    return(
      ...
      <div class="grid gap-10 md:grid-cols-3 md:gap-4  bg-sky-50 rounded-2xl shadow-sm pt-10 ">
        <div class="rounded-xl bg-white backdrop-blur-1 shadow-2xl mb-4  p-4 text-center ">
          ...
          <Link to="list/">
          <button class="text-darken mb-3 text-xl font-medium lg:px-14 bg-blue-400 hover:bg-blue-300 text-white p-5 rounded-2xl" href="#">Criminals</button>
          </Link>
          <p> <br/> 
          <br/>
          </p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 3.75H6.912a2.25 2.25 0 0 0-2.15 1.588L2.35 13.177a2.25 2.25 0 0 0-.1.661V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 0 0-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859M12 3v8.25m0 0-3-3m3 3 3-3" />
          ...
          <button class="text-darken mb-3 text-xl font-medium lg:px-14 bg-blue-400 hover:bg-blue-300 text-white p-5 rounded-2xl" href="#">Requests</button>
          </Link>
          <p> <br/> 
          <br/>
          </p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
          ...
          <Link to="clerkrequest/">
          <button class="text-darken mb-3 text-xl font-medium lg:px-14 bg-blue-400 hover:bg-blue-300 text-white p-5 rounded-2xl" href="#">Respond</button>
          </Link>
          <p> <br/> 
          <br/>
          </p>
