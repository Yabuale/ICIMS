const ClerkRequest = () =>{
   return(
      <>
   <div className="flex justify-center ml-24 mt-12 h-full shadow-lg">
            ...
            <div className="flex justify-between items-center h-48 border-b-2 mb-8">
                <div className="flex space-x-4 items-center">
                    <div className="h-12 w-12 rounded-full overflow-hidden">
                        <img src="https://bit.ly/2KfKgdy" loading="lazy" className="h-full w-full object-cover" alt="User" />
                    </div>
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1}
            ...
            <section className="mt-6 border rounded-xl bg-gray-50 mb-3">
                ...
                d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                    ...
                    <button className="bg-sky-800 text-white px-6 py-2 rounded-xl">Respond</button>
                </div>
            </section>
        </section>
