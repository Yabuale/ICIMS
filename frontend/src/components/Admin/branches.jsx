   ...
   const navigate= useNavigate()
    useEffect(() => {
      ...
      const handledelete = async (e) => {
       ...
       const url2 =`http://127.0.0.1:8000/systemadmin/branch/${id}/`
                    ...
                    <table className=" w-full  ">
                        <thead className="bg-sky-700  ">
                            <tr>
                                ...
                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">Region</th>
                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-white ">phone_no</th>
...
<td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
    <div className="inline-flex items-center gap-x-3">
        ...
        <div className="flex items-center gap-x-2">
            ...
            <div>
                <h2 className="font-medium text-gray-800  ">{account.branch_name}</h2>
            </div>
        </div>
    </div>
</td>
<td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2">
        ...
        <h2 className="text-sm font-normal text-sky-500">{account.woreda}</h2>
    </div>
</td>
...
<td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{account.region}</td>
...
<td className="px-4 py-4 text-sm whitespace-nowrap">
    ...
    <form onSubmit={handledelete}>
        ...
        {showdelModal && <ConfdelModal showdelModal={showdelModal} isLoading={isLoading} message={'you are about to delete a branch'} clickbutton={'Delete'} onClose={() => showdeleteModal(false)} />}
        ...
        <NavLink to={`/admin/editbranch/${account.id}`} className="text-gray-500 transition-colors duration-200  hover:text-yellow-500 focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
