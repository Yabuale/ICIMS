...
<section class="container px-4  mx-24      shadow-2xl bg-sky-50 p-10 rounded-2xl w-4/5  md:w-9/12 lg:w-4/5">
   <div class="flex items-center gap-x-3">
       <h2 class="text-lg font-medium text-sky-950 ">Local Admins</h2>

       <span class="px-3 py-1 text-xs text-sky-950 bg-sky-200 rounded-full  ">999 Local admins</span>
   </div>
   <div className="flex items-center justify-center p-6">
            <div className="w-full max-w-lg">
                <form className="mt-5 sm:flex sm:items-center">
                    <input id="q" name="q" className="inline w-full rounded-md border border-gray-300 bg-white py-2 pl-3 pr-3 leading-5 placeholder-gray-500 focus:border-sky-500 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="search local admin" type="search" autoFocus value="" />
